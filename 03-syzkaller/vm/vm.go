...
import (
	...
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/adb"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/gce"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/gvisor"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/isolated"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/kvm"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/odroid"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/qemu"
	_ "github.com/ZHYfeng/Dependency/03-syzkaller/vm/vmm"
)
...
func (pool *Pool) Create(index int) (*Instance, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to create instance temp dir %v : %v", pool.workdir, err)
	}
