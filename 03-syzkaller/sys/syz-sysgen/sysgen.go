...
func generate(target *targets.Target, prg *compiler.Prog, consts map[string]uint64, out io.Writer) {
	...
	fmt.Fprintf(out, "import . \"github.com/ZHYfeng/2018_dependency/03-syzkaller/prog\"\n")
	fmt.Fprintf(out, "import . \"github.com/ZHYfeng/2018_dependency/03-syzkaller/sys/%v\"\n\n", target.OS)
