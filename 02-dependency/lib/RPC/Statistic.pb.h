...
public:
  ...
  explicit constexpr Coverage_CoverageEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit Coverage_CoverageEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class Coverage final :
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::MapField<
      ...
      ::PROTOBUF_NAMESPACE_ID::uint32, ::PROTOBUF_NAMESPACE_ID::uint32,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT32,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT32> coverage_;
...
class UsefulInput final :
 ...
 public:
  inline UsefulInput() : UsefulInput(nullptr) {}
  ~UsefulInput() override;
  explicit constexpr UsefulInput(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(UsefulInput* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit UsefulInput(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
public:
  ...
  explicit constexpr Statistics_StatEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit Statistics_StatEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class Statistics final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::dra::Coverage* release_coverage();
  ...
  void unsafe_arena_set_allocated_coverage(
      ::dra::Coverage* coverage);
  ::dra::Coverage* unsafe_arena_release_coverage();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::MapField<
      ...
      ::PROTOBUF_NAMESPACE_ID::int32, ::dra::Statistic,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE> stat_;
...
inline ::dra::Time* Coverage::add_time() {
  ::dra::Time* _add = _internal_add_time();
...
inline void UsefulInput::unsafe_arena_set_allocated_input(
    ::dra::Input* input) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dra.UsefulInput.input)
}
...
inline ::dra::Input* UsefulInput::unsafe_arena_release_input() {
...
inline void Statistics::unsafe_arena_set_allocated_coverage(
    ::dra::Coverage* coverage) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dra.Statistics.coverage)
}
...
inline ::dra::Coverage* Statistics::unsafe_arena_release_coverage() {
...
inline ::dra::Coverage* Statistics::_internal_mutable_coverage() {
  ...
  if (coverage_ == nullptr) {
    auto* p = CreateMaybeMessage<::dra::Coverage>(GetArenaForAllocation());
    coverage_ = p;
  }
  return coverage_;
}
inline ::dra::Coverage* Statistics::mutable_coverage() {
  ::dra::Coverage* _msg = _internal_mutable_coverage();
...
inline void Statistics::set_allocated_coverage(::dra::Coverage* coverage) {
  ...
  if (coverage) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::dra::Coverage>::GetOwningArena(coverage);
    if (message_arena != submessage_arena) {
...
inline ::dra::UsefulInput* Statistics::add_useful_input() {
  ::dra::UsefulInput* _add = _internal_add_useful_input();
