...
_TASKSTATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='not_find_input', index=2, number=-5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='not_find_write_address', index=3, number=-4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='not_find_write_input', index=4, number=-3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable_write', index=5, number=11,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='stable_write', index=6, number=12,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable_condition', index=7, number=13,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='stable_condition', index=8, number=14,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable_insert_write', index=9, number=15,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='stable_insert_write', index=10, number=16,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable_insert_condition', index=11, number=17,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='stable_insert_condition', index=12, number=18,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable', index=13, number=19,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tested', index=14, number=21,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='covered', index=15, number=22,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='recursive', index=16, number=31,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='out', index=17, number=32,
      serialized_options=None,
      type=None),
  ],
...
_WRITESTATEMENTKIND = _descriptor.EnumDescriptor(
  name='WriteStatementKind',
  full_name='dra.WriteStatementKind',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='WriteStatementConstant', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WriteStatementNonconstant', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WriteStatementDependencyRelated', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WriteStatementNotDependencyRelated', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_WRITESTATEMENTKIND)

WriteStatementKind = enum_type_wrapper.EnumTypeWrapper(_WRITESTATEMENTKIND)
_TASKKIND = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Ckeck', index=2, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Normal', index=3, number=5,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_TASK.fields_by_name['kind'].enum_type = _WRITESTATEMENTKIND
...
DESCRIPTOR.enum_types_by_name['WriteStatementKind'] = _WRITESTATEMENTKIND
