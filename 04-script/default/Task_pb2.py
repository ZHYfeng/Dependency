...
_TASKSTATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable_condition', index=6, number=12,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable_insert', index=7, number=13,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='unstable', index=8, number=14,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tested', index=9, number=21,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='covered', index=10, number=22,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='recursive', index=11, number=31,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='out', index=12, number=32,
      serialized_options=None,
      type=None),
  ],
