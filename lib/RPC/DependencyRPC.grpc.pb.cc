...
void DependencyRPC::Stub::experimental_async::GetNewInput(::grpc::ClientContext* context, const ::dra::Empty* request, ::dra::NewInput* response, std::function<void(::grpc::Status)> f) {
...
void DependencyRPC::Stub::experimental_async::GetNewInput(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::dra::NewInput* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetNewInput_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::dra::NewInput>* DependencyRPC::Stub::AsyncGetNewInputRaw(::grpc::ClientContext* context, const ::dra::Empty& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::dra::NewInput>* DependencyRPC::Stub::PrepareAsyncGetNewInputRaw(::grpc::ClientContext* context, const ::dra::Empty& request, ::grpc::CompletionQueue* cq) {
...
void DependencyRPC::Stub::experimental_async::SendInput(::grpc::ClientContext* context, const ::dra::Input* request, ::dra::Empty* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_SendInput_, context, request, response, std::move(f));
}

void DependencyRPC::Stub::experimental_async::SendInput(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::dra::Empty* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_SendInput_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::dra::Empty>* DependencyRPC::Stub::AsyncSendInputRaw(::grpc::ClientContext* context, const ::dra::Input& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::dra::Empty>* DependencyRPC::Stub::PrepareAsyncSendInputRaw(::grpc::ClientContext* context, const ::dra::Input& request, ::grpc::CompletionQueue* cq) {
