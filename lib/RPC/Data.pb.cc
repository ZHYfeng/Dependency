...
PROTOBUF_NAMESPACE_OPEN
        template<>
        PROTOBUF_NOINLINE ::dra::data *Arena::CreateMaybeMessage<::dra::data>(Arena *arena) {
            return Arena::CreateInternal<::dra::data>(arena);
        }

        template<>
        PROTOBUF_NOINLINE ::dra::all_data *Arena::CreateMaybeMessage<::dra::all_data>(Arena *arena) {
