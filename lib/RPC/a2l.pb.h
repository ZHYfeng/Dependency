...
PROTOBUF_NAMESPACE_OPEN
        template<>
        ::dra::address *Arena::CreateMaybeMessage<::dra::address>(Arena *);

        template<>
        ::dra::address_AddrEntry_DoNotUse *Arena::CreateMaybeMessage<::dra::address_AddrEntry_DoNotUse>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace dra {
...
// ===================================================================
    ...
    public:
        ...
        static const address_AddrEntry_DoNotUse *
        internal_default_instance() { return reinterpret_cast<const address_AddrEntry_DoNotUse *>(&_address_AddrEntry_DoNotUse_default_instance_); }

        static bool ValidateKey(std::string *s) {
            return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), s->size(),
