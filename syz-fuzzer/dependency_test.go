...
func TestRemoveSameResource(t *testing.T) {
	t.Parallel()
	tests := [][]byte{
		[]byte("r0 = openat$kvm(0xffffffffffffff9c, &(0x7f0000000140)='/dev/kvm\x00', 0x0, 0x0)\n" +
		...
		[]byte("r0 = openat$ptmx(0xffffffffffffff9c, &(0x7f0000000000)='/dev/ptmx\x00', 0x802, 0x0)\n" +
	...
	for ti, test := range tests {
		test := test
		removeSameResource(test, 8)
		t.Run(fmt.Sprint(ti), func(t *testing.T) {
			result, idx := removeSameResource(test, 8)
